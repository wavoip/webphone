...
function Tabs({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.Root>) {
  return <TabsPrimitive.Root data-slot="tabs" className={cn("wv:flex wv:flex-col wv:gap-2", className)} {...props} />;
}
...
function TabsList({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.List>) {
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "wv:inline-flex wv:bg-muted wv:text-muted-foreground wv:inline-flex wv:h-9 wv:w-fit wv:items-center wv:justify-center wv:rounded-lg wv:p-[3px]",
        className,
      )}
      {...props}
    />
...
function TabsContent({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.Content>) {
  return (
    <TabsPrimitive.Content data-slot="tabs-content" className={cn("wv:flex-1 wv:outline-none", className)} {...props} />
  );
}
